# QBO Invoice Creator - Scheduled Task Script
# This script runs the Docker container to create QuickBooks Online invoices from monthly usage

# Set up logging
$LogFile = "C:\Users\WesleyHartman\Documents\APD Repos\invoice_send_aws\create-invoices.log"
$Timestamp = Get-Date -Format "yyyy-MM-dd HH:mm:ss"

# Log start
Add-Content -Path $LogFile -Value ""
Add-Content -Path $LogFile -Value "=========================================="
Add-Content -Path $LogFile -Value "$Timestamp - Starting create-invoices task"
Add-Content -Path $LogFile -Value "=========================================="
...
try {
    ...
    Add-Content -Path $LogFile -Value "$Timestamp - Executing: docker-compose run --rm invoice-processor --create-invoices"

    $Output = docker-compose run --rm invoice-processor --create-invoices 2>&1
