# GitHub Monthly Digest - Scheduled Task Script
# This script runs the Docker container to send the monthly GitHub commit digest email

# Set up logging
$LogFile = "C:\Users\WesleyHartman\Documents\APD Repos\invoice_send_aws\github-digest.log"
$Timestamp = Get-Date -Format "yyyy-MM-dd HH:mm:ss"

# Log start
Add-Content -Path $LogFile -Value ""
Add-Content -Path $LogFile -Value "=========================================="
Add-Content -Path $LogFile -Value "$Timestamp - Starting github-digest task"
Add-Content -Path $LogFile -Value "=========================================="
...
try {
    ...
    Add-Content -Path $LogFile -Value "$Timestamp - Executing: docker-compose run --rm invoice-processor --github-digest"

    $Output = docker-compose run --rm invoice-processor --github-digest 2>&1
